      ...
      <div className="flex-1 flex flex-col max-h-screen overflow-y-auto">
        ...
        <footer className="py-4 px-8 border-t border-white/5 text-center">
          <a
            ...
            className="inline-flex items-center gap-1.5 text-xs text-gray-600 hover:text-purple-400 transition-colors duration-200 group"
          >
            <span>Built by</span>
            <span className="font-semibold text-gray-500 group-hover:text-purple-400 transition-colors">Tharun R</span>
